...
<?php
	...
	echo '<tr><td><p><b>底部内链</b><br/><span class="note">&nbsp;</span></p></td><td><p><textarea cols="3" rows="6" id="ZC_BLOG_INNERLINK" name="ZC_BLOG_INNERLINK" style="width:600px;">';
	if(isset($zbp->option['ZC_BLOG_INNERLINK'])){echo htmlspecialchars($zbp->option['ZC_BLOG_INNERLINK']);}
	echo '</textarea></p></td></tr>';
	echo '<tr><td><p><b>底部外链</b><br/><span class="note">&nbsp;</span></p></td><td><p><textarea cols="3" rows="6" id="ZC_BLOG_OUTLINK" name="ZC_BLOG_OUTLINK" style="width:600px;">';
	if(isset($zbp->option['ZC_BLOG_OUTLINK'])){echo htmlspecialchars($zbp->option['ZC_BLOG_OUTLINK']);}
	echo '</textarea></p></td></tr>';
