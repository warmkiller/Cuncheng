<?php
require $blogpath . 'zb_users/plugin/Nobird_Seo_Tools/CommentMng/class_ip.php';
...
$p=new Pagebar('{%host%}zb_users/plugin/Nobird_Seo_Tools/CommentMng/commentmng.php?act=CommentMng{&page=%page%}{&ischecking=%ischecking%}{&search=%search%}',false);
