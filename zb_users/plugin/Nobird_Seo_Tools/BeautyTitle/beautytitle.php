...
if(count($_POST)>0){
	...
	$zbp->Config('Nobird_BeautyTitle')->s_all = $_POST['s_all'];
	$zbp->Config('Nobird_BeautyTitle')->s_all_list = $_POST['s_all_list'];
...
<tr>
	<td><p align='left'><b>分类/Tag/日期首页标题结构</b></p></td>
	<td><input id='s_all' name='s_all' style='width:500px;' type='text' value='<?php echo htmlspecialchars($zbp->Config('Nobird_BeautyTitle')->s_all);?>'> 可以使用空格</td>
</tr>
<tr>
	<td><p align='left'><b>分类/Tag/日期列表页标题结构</b></p></td>
	<td><input id='s_all_list' name='s_all_list' style='width:500px;' type='text' value='<?php echo htmlspecialchars($zbp->Config('Nobird_BeautyTitle')->s_all_list);?>'> 可以使用空格</td>
</tr>
<tr>
...
<tr>
	...
	<p>4、推荐的分隔符为：短线（-）和竖线（|），网站名称中不推荐使用下划线（_）。</p>
	<p>5、插件设置的标题分隔符仅能控制除插件规范之外的页面标题，规范之内的标题请在内容里直接设置分隔符。</p>
	<p>6、%name%---网站标题，%subname%---网站副标题。</p>
	<p>7、%page%---第%page%页，%postname%---文章名。</p>
	<p>8、%catetagdate%---分类名/tag名/日期。</p>
	<p>9、%nbname%，标题附加字段，默认仅在分类与tag页面有效，可以在分类和tag编辑页面进行设置。</p>
