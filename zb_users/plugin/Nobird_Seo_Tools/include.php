...
function Nobird_Seo_Tools_kwlink(&$template){
	global $zbp;
  KeyWordLinks_Main($template);
}

function Nobird_Seo_Tools_Sitemap(){
	global $zbp;
  Nobird_Spider_Get_Sitemap();
}
...
function InstallPlugin_Nobird_Seo_Tools(){
	global $zbp;
		...
		KeyWordLinks_CreateTable();
    KeyWordLinks_DefaultCode();
