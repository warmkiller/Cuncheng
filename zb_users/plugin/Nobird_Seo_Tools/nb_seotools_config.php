...
//echo $filename; // use filename ,judgment focus
		...
		echo '<a href="'.$bloghost.'zb_users/plugin/'.$GLOBALS['Nobird_Plugin_Name'].'/KeyAndDes/keyanddes.php"><span class="m-left ' . ($filename=='keyanddes.php'?'m-now':'') . '">关键词&描述设置</span></a>';
