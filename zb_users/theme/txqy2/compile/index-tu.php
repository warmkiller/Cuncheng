...
<div class="zh">
<div class="cpzx xia15"><?php  echo $category->Name;  ?></div>
<div class="rigth">
<dl class="chanp xia15"><dt class="ybbt"><span class="fuse">当前位置</span><a href="<?php  echo $host;  ?> ">首页</a> / <a href="<?php  echo $category->Url;  ?>"><?php  echo $category->Name;  ?></a></dt>
<dd><ul>
