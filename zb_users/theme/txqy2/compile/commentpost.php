...
<?php if ($option['ZC_COMMENT_VERIFY_ENABLE']) { ?>
	<p><label for="inpVerify">验证</label><input type="text" name="inpVerify" id="inpVerify" value="" size="28" tabindex="5" /><img src="<?php  echo $article->ValidCodeUrl;  ?>" class="verifyimg" onclick="javascript:this.src='<?php  echo $article->ValidCodeUrl;  ?>&amp;tm='+Math.random();" /> <font color="#ff6f3d">必填</font></p>
<?php } ?>
