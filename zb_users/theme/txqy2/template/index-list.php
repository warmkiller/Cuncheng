...
<!-- <div class="xwzx xia15">{$category.Name}</div> -->
<br>

<div class="zh">
<div class="rigth">
<dl class="xinw xia15"><dt class="ybbt"><span class="fuse">当前位置</span><a href="{$host} ">首页</a> / <a href="{$category.Url}">{$category.Name}</a></dt>
<dd><ul>
