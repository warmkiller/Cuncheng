...
<div class="homemain">
 ...
 <div class="layout">
    <div class="homenews fl">
      <div class="titels">
        <h2 class="fl title1"><a href='{$categorys[11].Url}'>{$categorys[11].Name}</a></h2>
        <div class="fr more"> <a class="a-more iconbg" href="{$categorys[11].Url}"> 更多</a></div>
      </div>
      {$array=Getlist(1,null,null,null,array($zbp->GetTagByID(5)));}
      {foreach $array as $related}

      <div class="homemain-conts homenews-conts" style="border:none;">
        <dl>
          <dt class="pic"> <img src="/img/ad.png" alt="{$related.Title}" width="160" height="103"/> </dt>
          <dd class="cont">
            <h3><a href="{$related.Url}" target="_blank">{$related.Title}</a></h3>
            <p> {$related.Intro}</p>
          </dd>
        </dl>
        {/foreach}
        ...
        <div class="homenews-list">
            ...
            {$array=GetList(3,11,null,null,null,null,array('has_subcate'=>true));}
            {foreach $array as $related}
        ...
        <div class="homenews fl">
      <div class="titels">
        <h2 class="fl title2"><a href='{$categorys[5].Url}'>{$categorys[5].Name}</a></h2>
        <div class="fr more"> <a class="a-more iconbg" href="{$categorys[5].Url}"> 更多</a></div>
      </div>

      <div class="homemain-conts homenews-conts" style="border:none;">
        <div class="homenews-list">
            <ul class="two_col_list" style="margin-top: 12px;">
            {$array=GetList(7,5,null,null,null,null,array('has_subcate'=>true));}
            {foreach $array as $related}
            <li> <a href="{$related.Url}" target="_blank">{$related.Title}</a> </li>
            {/foreach}
                </ul>
